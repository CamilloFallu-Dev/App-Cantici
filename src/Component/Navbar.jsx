    ...
    <div>
      <nav className="fixed bottom-0 w-full bg-slate-600 text-slate-100 p-4 text-md shadow-2xl flex gap-5 justify-center z-50">
        ...
        <div className="relative ">
          ...
          {dropdownOpen && (
            <div className="absolute bottom-14 bg-slate-700 text-white rounded-md shadow-lg flex flex-col overflow-auto py-2 w-40 text-sm">
              <Link
                to="/raccolta"
                className="hover:bg-slate-600 px-4 py-2"
